 ...
 * that follows the active item. Supports both controlled and uncontrolled modes.
 */
    ...
    >
      {items.map(({ id, icon, label, onClick }, index) => (
        <a
          ...
          tabIndex={0}
          onKeyDown={e => {
            if (e.key === 'Enter' || e.key === ' ') handleItemClick(index, onClick);
          }}
        >
          {cloneElement(icon, {
